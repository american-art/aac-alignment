...
REPO_CONFIG = [
    {
       ...
       'num_partitions': 50,
       'preprocess': ['../csv_fixer.py', 'Item.xls', 'Item.json']
    },
   {
      'path': repo_path,
      ...
      'num_partitions': 50,
      'preprocess': ['../csv_fixer.py', 'Item_Collections.xls', 'Item_Collections.json']
   },
   {
      'path': repo_path,
      ...
      'num_partitions': 50,
      'preprocess': ['../csv_fixer.py', 'Item_DigitalResources.xls', 'Item_DigitalResources.json']
   },
   {
      'path': repo_path,
      'name': 'Item_Events',
      ...
      'num_partitions': 50,
      'preprocess': ['../csv_fixer.py', 'Item_Events.xls', 'Item_Events.json']
   },
   {
      'path': repo_path,
      ...
      'num_partitions': 50,
      'preprocess': ['../csv_fixer.py', 'Item_Institutions.xls', 'Item_Institutions.json']
   },
   {
      'path': repo_path,
      'name': 'Item_People',
      ...
      'num_partitions': 50,
      'preprocess': ['../csv_fixer.py', 'Item_People.xls', 'Item_People.json']
   },
   {
      'path': repo_path,
      ...
      'num_partitions': 50,
      'preprocess': ['../csv_fixer.py', 'Item_PeopleOccupations.xls', 'Item_PeopleOccupations.json']
   },
   {
      'path': repo_path,
      ...
      'num_partitions': 50,
      'preprocess': ['../csv_fixer.py', 'Item_PeoplePlaces.xls', 'Item_PeoplePlaces.json']
   },
   {
      'path': repo_path,
      'name': 'Item_Subjects',
      ...
      'num_partitions': 50,
      'preprocess': ['../csv_fixer.py', 'Item_Subjects.xls', 'Item_Subjects.json']
   },
   {
      'path': repo_path,
      ...
      'num_partitions': 50,
      'preprocess': ['../csv_fixer.py', 'Item_to_Collection.xls', 'Item_to_Collection.json']
   },
   {
      'path': repo_path,
      'name': 'Item_to_type',
      ...
      'num_partitions': 50,
      'preprocess': ['../csv_fixer.py', 'Item_to_type.xls', 'Item_to_type.json']
   },
   {
      'path': repo_path,
      ...
      'preprocess': ['../csv_fixer.py', 'AAA_Metadata.xls', 'AAA_Metadata.json']
   }
]
